...
cl <- makeCluster(5) # put the number of CPU cores you want to use within the bracket. Here I have used 10
...
system2("mkdir","../Graphs")
CairoPDF("../Graphs/Updated_RTT_plots_new.pdf",35.1,24.81,bg="transparent")
par(mfrow=c(2,3))

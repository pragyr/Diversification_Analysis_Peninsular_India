...
setwd("/media/evol-eco/New_volume/Pragyadeep_RPANDA_analysis/model_comparisons_parallelized/old_files_before_PNAS_review/")
list.files()
...
for(i in 1:nrow(df)){
  ...
  for(j in 1:100){
    ...
    lineage_dir_path <- paste0("/media/evol-eco/New_volume/Pragyadeep_RPANDA_analysis/Simulations/simulated_trees/",df$lineage.names[i])
...
setwd("/media/evol-eco/New_volume/Pragyadeep_RPANDA_analysis/Simulations/model_fits_of_simulated_trees/")
...
setwd("/media/evol-eco/New_volume/Pragyadeep_RPANDA_analysis/Simulations/RTT_data_simulations/")
